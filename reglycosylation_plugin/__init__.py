...
try:
    ...
    def __init_plugin__(app=None):
        from . import reglycosylation_plugin # Import the main plugin code (relative import)
        reglycosylation_plugin.__init_plugin__(app)
    ...
    # For simple cases, just importing might be enough if reglycosylation_plugin.py
    # directly calls addmenuitemqt on import (less clean).
    # The __init_plugin__ structure is preferred.
    print("Reglycosylation Plugin: Could not use __init_plugin__, attempting direct load (may fail).")
    from . import reglycosylation_plugin
